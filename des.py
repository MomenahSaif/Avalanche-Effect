...
def main():
  """
  Main function for using the DES class.
  """
  pt = "123456ABCD132536"
  ...
  cipher_text2 = des2.bin2hex(des2.encrypt(pt2,rk2,rkh2))
  ...
  for i in range(16):  # Assuming there are 10 rounds
        round_output_A = des.round_outputs[i].replace(" ", "")  # Remove spaces
        round_output_B = des2.round_outputs[i].replace(" ", "")  # Remove spaces
  ...
  cipher_text3 = des3.bin2hex(des3.encrypt(pt3,rk3,rkh3))
  ...
  for i in range(16):  
        round_output_A3 = des.round_outputs[i].replace(" ", "")  # Remove spaces
        round_output_B3 = des3.round_outputs[i].replace(" ", "")  # Remove spaces
