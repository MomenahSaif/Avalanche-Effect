...
if __name__ == "__main__":
    ...
    [tenRound2, allkey2] = AESTest2.encrypt10round(plaintext2, key)
    ...
    for i in range(10):  # Assuming there are 10 rounds
    ...
    [tenRound3, allkey3] = AESTest3.encrypt10round(plaintext3, key)
