...
# First encryption with key1
  rk1, rkh1 = des1.generate_round_keys()
  intermediate_cipher = des1.bin2hex(des1.encrypt(pt, rk1, rkh1))
  print("Cipher Text from first round:", intermediate_cipher)
  print("\nEncryption 2")
  print("Key 2:", key2)
  des2 = DES(key2)
# Second encryption with key2
  rk2, rkh2 = des2.generate_round_keys()
  cipher_text = des2.bin2hex(des2.encrypt(intermediate_cipher, rk2, rkh2))
...
# First encryption with key1
  ...
  intermediate_cipher2 = des3.bin2hex(des3.encrypt(pt2, rk3, rkh3))
  print("Cipher Text from first round:", intermediate_cipher2)
  print("\nEncryption 2")
  print("Key 2:", key2)
  des4 = DES(key2)
# Second encryption with key2
  rk4, rkh4 = des4.generate_round_keys()
  cipher_text2 = des4.bin2hex(des4.encrypt(intermediate_cipher2, rk4, rkh4))

  print(" Final Cipher Text:", cipher_text2)
  print("\n\n------------------------Avalanche Effect--------------------------------\n")    
  #total_changed_bits = 0

    # Compare the round outputs of AESTest and AESTest2
  for i in range(16):  
        round_output_A = des2.round_outputs[i].replace(" ", "")  # Remove spaces
        round_output_B = des4.round_outputs[i].replace(" ", "")  # Remove spaces
...
# First encryption with key1
  ...
  intermediate_cipher3 = des5.bin2hex(des5.encrypt(pt3, rk5, rkh5))
  print("Cipher Text from first round:", intermediate_cipher3)
  print("\nEncryption 2")
  print("Key 2:", key2)
  des6 = DES(key2)
# Second encryption with key2
  rk6, rkh6 = des6.generate_round_keys()
  cipher_text3 = des6.bin2hex(des6.encrypt(intermediate_cipher3, rk6, rkh6))
  print(" Final Cipher Text:", cipher_text3)
    
  print("\n\n------------------------Avalanche Effect--------------------------------\n")    
  #total_changed_bits3 = 0

    # Compare the round outputs of AESTest and AESTest3
  for i in range(16):  # Assuming there are 10 rounds
        round_output_A3 = des2.round_outputs[i].replace(" ", "")  # Remove spaces
        round_output_B3 = des6.round_outputs[i].replace(" ", "")  # Remove spaces
